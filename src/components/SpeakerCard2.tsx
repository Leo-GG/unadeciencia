...
const SpeakerCard2 = ({ name, title, description, expertise, image }: SpeakerCardProps) => {
  return (
      ...
      <CardContent className="p-6">
        <div className="flex flex-col items-center text-center space-y-4">
          <div className="relative">
            <div className="w-24 h-24 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg border-2 border-blue-500 overflow-hidden">
              {image ? (
                <img 
                  src={image} 
                  alt={name}
