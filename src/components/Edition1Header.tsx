const Edition1Header = () => {
  return (
    <section className="relative min-h-screen bg-gradient-edition1 flex items-center justify-center overflow-hidden">
      {/* Animated bubble elements - original orange theme */}
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="inline-block bg-white/30 backdrop-blur-sm rounded-full px-6 py-2">
            <span className="text-white font-bold text-lg">1ª EDICIÓN</span>
          </div>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 mx-auto max-w-2xl">
            <div className="grid md:grid-cols-2 gap-4 text-white">
              <div className="flex items-center justify-center space-x-2">
                ...
                <div>
                  <p className="font-bold text-lg">18 de Septiembre 2024</p>
